...
public class CustomSwitch: UIControl {
    ...
    public var animationOptions: UIView.AnimationOptions = [UIView.AnimationOptions.curveEaseOut, UIViewAnimationOptions.beginFromCurrentState, UIViewAnimationOptions.allowUserInteraction]
    ...
    public var thumbView = CustomThumbView(frame: CGRect.zero).thumbImageView
